...
const Folder = ({
  ...
  return (
    <div id={`bookmark-id-${id}`} style={scaleStyle} className={`${className} w-[100px]`} onContextMenu={e=>{
      e.preventDefault();
...
// type,title,time,date,url
      setContext(["Folder",folderName,`${hours}:${minutes}`,`${day}/${monthName}/${year}`,'',id])
    }}>
      <div
      ...
      <p className="text-base text-white mt-2">{folderName}</p>
    </div>
  );
};
